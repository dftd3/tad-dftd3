...
def _load_cn(
    ...
    return torch.tensor(
        [
            ...
            [+0.0000, +0.9662, +1.8075, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Ra
            [+0.0000, +2.9070, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Ac
            [+0.0000, +2.8844, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Th
            [+0.0000, +2.8738, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Pa
            [+0.0000, +2.8878, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # U
            [+0.0000, +2.9095, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Np
            [+0.0000, +1.9209, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Pu
            [+0.0000, +1.9209, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Am
            [+0.0000, +1.9209, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Cm
            [+0.0000, +1.9209, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Bk
            [+0.0000, +1.9209, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Cf
            [+0.0000, +1.9209, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Es
            [+0.0000, +1.9209, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Fm
            [+0.0000, +1.9209, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Md
            [+0.0000, +1.9209, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # No
            [+0.0000, +1.9209, -1.0000, -1.0000, -1.0000, -1.0000, -1.0000 ],  # Lr
